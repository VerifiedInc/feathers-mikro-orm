...
class Service extends adapter_commons_1.AdapterService {
    ...
    async get(id, params) {
        ...
        const entity = await this.orm.em.findOne(this.name, id || where, (params === null || params === void 0 ? void 0 : params.populate) && [...params === null || params === void 0 ? void 0 : params.populate]);
        if (!entity) {
