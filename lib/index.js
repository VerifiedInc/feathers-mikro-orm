...
class Service extends adapter_commons_1.AdapterService {
    ...
    async get(id, params) {
        ...
        const entity = await this._getEntityRepository().findOne(id || where, params === null || params === void 0 ? void 0 : params.populate);
        if (!entity) {
    ...
    async patch(id, data, params) {
        ...
        if (id) {
            const entity = await entityRepository.findOne(where, params === null || params === void 0 ? void 0 : params.populate);
            if (!entity) {
    ...
    async remove(id, params) {
        ...
        else if ((params === null || params === void 0 ? void 0 : params.query) || (params === null || params === void 0 ? void 0 : params.where)) {
            const query = (params === null || params === void 0 ? void 0 : params.query) || (params === null || params === void 0 ? void 0 : params.where);
