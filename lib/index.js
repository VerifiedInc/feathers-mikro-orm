...
var MikroOrmService = /** @class */ (function (_super) {
    __extends(MikroOrmService, _super);
    function MikroOrmService(options) {
    ...
    MikroOrmService.prototype.setup = function (app) {
        this.app = app;
    };
    MikroOrmService.prototype.get = function (id) {
    ...
    MikroOrmService.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var entity;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.repository.persistAndFlush(entity)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, entity];
                }
    ...
    MikroOrmService.prototype.patch = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            var entity;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    MikroOrmService.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var entity;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.repository.removeAndFlush(entity)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, entity];
                }
